...
public class MyOffersController {
    ...
    @Autowired
    public MyOffersController(ItemService itemService, PersonService personService) {
    ...
    public String auctions(Model model, @AuthenticationPrincipal User user) {
        ...
        int pageSize = 12;
        Page<Item> page = itemService.findOffers(person, pageNo, pageSize, sortByFilter, startedFilter, notStartedFilter, virtualPaymentFilter, physicalPaymentFilter, searchKey, true);
